...
애드 혹, 깊이 우선 탐색, 그래프 이론, 그래프 탐색, 그리디 알고리즘, 구현

### 제출 일자

2026년 1월 27일 17:45:34
...
<p>Rows are numbered from top to bottom beginning with 1. Columns are numbered from left to right beginning with 1. For example the outline of the ‘v’ shaped region above would be: </p>
